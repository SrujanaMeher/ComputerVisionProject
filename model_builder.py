...
#
# To finetune models, all training images must be generated by image_processing.py and be
# located in train and val directories
#
# To get predictions on a test set, test jpeg files must be generated with 
# image_processing.py and be located inside a test directory within the current working directory.
